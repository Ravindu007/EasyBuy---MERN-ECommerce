...
const ProductRegistryApp = forwardRef((props, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    async handleRegisterProduct() {
      ...
      try {
        ...
        generateQR(generatedHashValue, productId, '123456');
...
const handleRegisterProduct = async (ref) => {
  if (ref.current) {
    await ref.current.handleRegisterProduct();
  }
};
